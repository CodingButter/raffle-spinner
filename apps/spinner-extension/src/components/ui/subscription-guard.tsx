  ...
  return (
    <Card className="border-amber-200 bg-amber-50">
      <CardHeader className="pb-3">
        ...
        <CardDescription className="text-xs text-amber-700">{description}</CardDescription>
      </CardHeader>
        ...
        <CardContent className="pt-0">
          <div className="space-y-3">
            <div className="space-y-1">
              <p className="text-xs font-medium text-amber-800 mb-2">Pro features include:</p>
            ...
            <Button onClick={onUpgradeClick} size="sm" className="w-full text-xs">
              Upgrade to Pro
            </Button>
          </div>
        </CardContent>
...
export function RaffleGuard({
  ...
  return (
    <SubscriptionGuard feature="raffles" onUpgradeClick={onUpgradeClick}>
      {children}
    </SubscriptionGuard>
  );
}
...
export function ApiGuard({
  ...
  return (
    <SubscriptionGuard feature="api" onUpgradeClick={onUpgradeClick}>
      {children}
    </SubscriptionGuard>
  );
}
