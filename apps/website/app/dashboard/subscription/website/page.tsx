 ...
 *
 * Manage website product subscriptions
 */
...
export default function WebsiteSubscriptionPage() {
  ...
  const websiteCategory = productsByCategory.website;
  const websiteProducts = websiteCategory?.products || [];
  ...
  return <SubscriptionCards products={websiteProducts} user={user} onUpgrade={handleUpgrade} />;
}
