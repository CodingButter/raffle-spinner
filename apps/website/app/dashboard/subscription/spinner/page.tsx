/**
 * Spinner Subscription Page
 *
 * Manage spinner product subscriptions
 */
...
export default function SpinnerSubscriptionPage() {
  ...
  const spinnerCategory = productsByCategory.spinner;
  const spinnerProducts = spinnerCategory?.products || [];
  ...
  return <SubscriptionCards products={spinnerProducts} user={user} onUpgrade={handleUpgrade} />;
}
