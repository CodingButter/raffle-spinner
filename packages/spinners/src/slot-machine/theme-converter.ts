 ...
 * 
 * Converts between public SpinnerTheme interface and internal theme format
 * required by drawing functions. Maintains backward compatibility while
 * allowing for cleaner public API.
 */
 ...
 * required by the drawing functions.
 * 
